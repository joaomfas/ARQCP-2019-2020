...
######################################################
	...
	movl $0, %ecx  #Clean register ebx
	movw s1, %ax   #Move s1 value to ax (16 bits)
	movw s2, %cx   #Move s2 value to cx (16 bits)
	addb %ch, %al  #Add ch to al, save in al (8 bits)
	addb %cl, %ah  #Add cl to ah, save in ah (8 bits)
