...
######################################################
	...
	subl %ecx, %ebx #subtract ecx to ebx. Result is in ebx (CONST-OP1)
	subl %eax, %edx #subtract eax to edx. Result is in edx (CONST-OP2)
	subl %edx, %ebx #substract edx to ebx. Result is in ebx (CONST-OP1)-(CONST-OP2)
